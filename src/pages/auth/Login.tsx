...
export default function Login() {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      // In Supabase, tokens are usually persisted to localStorage by default.
      // Remember me logic might require custom persistence strategies if we want short-lived cookies,
      // but by default Supabase persists session. A UI toggle is often placebo unless you adjust `storageKey`.
